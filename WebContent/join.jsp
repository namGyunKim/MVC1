...
<script type="text/javascript">
	...
	function confirmId(){
		...
		/* if(request.getParameterValues("id")===""){
			alter("ID를 입력하세요");
			return; 
		} */
		
	
		url= "confirmId.jsp?id=" ; +아이디값
		open(url, "confirm", "toolvar=no, loaction=no, status=no, scrollbars=no, menubar=no, resizable=no, width=300, height=200");
