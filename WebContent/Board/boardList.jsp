...
ArrayList<BoardVO> boardArray=board.getNameBoard(thisId);
%>
...
for(BoardVO imsi: boardArray){ %>
	<tr>
          <td><a href="boardDeleteProcess.jsp?boardNumber=<%=imsi.getBoardNumber() %>">
				<%=imsi.getBoardNumber() %></td>
			<td><a href="boardChangeForm.jsp?boardNumber=<%=imsi.getBoardNumber() %>">
				<%=imsi.getBoardTitle() %></td>
